...
for pr in prompts:
	...
	for prompt in prompts:
		...
		#with autocast(device):
			...
			for guidance in [4.5, 7.5,10.0,15.0, 20.0, 30.0]:
				...
				image.save("output/"+prompt+"_"+str(i)+"_g"+str(guidance)+"_iter"+str(steps)+".png")
				print("Saved output/"+prompt+"_"+str(i)+"_g"+str(guidance)+"_iter"+str(steps)+".png")
